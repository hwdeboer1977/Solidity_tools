...
// NEXT: USE CONTRACTS, see https://docs.chain.link/vrf/v2-5/subscription/create-manage#create-a-subscription-programmatically


 // Contract address: 0xB3Fb947A7Cd16b03a28cE0755EE839ccAebd6D94
 // Step 1: deploy contract
 // Get test LINK and ETH
 // Get subscription and add consumer (CA of deployed contract)
 // Call requestRandomWords function 
 // Call lastRequestId function
